                    ...
                    <div className={style.buttons}>
                      {!loadSVG && !astroSVG && (
                        <Button
                          ...
                          disabled={
                            !lat || !lng || !utcOffset || !dateOfBirth.length || !timeOfBirth.length
                          }
                          loading={loading}
                          onClick={() => {
                            handleSubmit();
            ...
            {intl.formatMessage(
              {
                ...
                defaultMessage:
                  'A new God is being created, blessed by the power of the previous generation God (tokenID={tokenID})',
              },
              {
                tokenID: tokenID,
              },
